  ...
  ({ params }: { params: Promise<{ user: string }> }) => {
    ...
    return (
      <>
        <div className={styles.user}>
          ...
          <div className={styles.user__content}>
            ...
            <div className={styles.user__right}>
              <SocialStats
                socialStats={sortedUserSocialStats}
                openFollowersModal={() => openUserFollowersModal(userInfo.id)}
                openFollowingModal={() => openUserFollowingModal(userInfo.id)}
              />
            </div>
          </div>
        </div>
        <FollowModal
          visible={isUserFollowersModalVisible}
        ...
        />
        <FollowModal
          visible={isUserFollowingModalVisible}
          users={userFollowing?.users}
